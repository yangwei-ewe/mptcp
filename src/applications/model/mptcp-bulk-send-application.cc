...
// Application Methods
void
MpTcpBulkSendApplication::StartApplication(void) // Called at time specified by Start
{
    NS_LOG_FUNCTION(this);
...
void
MpTcpBulkSendApplication::StopApplication(void) // Called at time specified by Stop
{
    NS_LOG_FUNCTION(this);
...
void
MpTcpBulkSendApplication::ConnectionSucceeded(Ptr<Socket> socket)
{
...
void
MpTcpBulkSendApplication::ConnectionFailed(Ptr<Socket> socket)
{
    NS_LOG_FUNCTION(this << socket);
...
void
MpTcpBulkSendApplication::DataSend(Ptr<Socket>, uint32_t)
{
    NS_LOG_FUNCTION(this);
