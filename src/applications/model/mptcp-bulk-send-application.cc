...
namespace ns3 {
    ...
    TypeId
        ...
        static TypeId tid = TypeId("ns3::MpTcpBulkSendApplication")
            ...
            .AddTraceSource("Tx", "A new packet is created and is sent",
                MakeTraceSourceAccessor(&MpTcpBulkSendApplication::m_txTrace), "ns3::Packet::TracedCallback")
            ;
        return tid;
    }
    ...
    void MpTcpBulkSendApplication::SendData(void) {
        ...
        while (((!m_maxBytes) || (m_totBytes < m_maxBytes)) && m_socket->GetTxAvailable()) { // Time to send more new data into MPTCP socket buffer
