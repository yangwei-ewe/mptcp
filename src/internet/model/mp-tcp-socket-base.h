...
class MpTcpSocketBase : public TcpSocketBase
{
  public: // public methods
    ...
    // used in future!
    int FillBuffer(uint8_t* buf, uint32_t size); // Fill sending buffer with data - TcpTxBuffer API
    ...
    uint32_t Recv(uint32_t size); // Receive data from receiveing buffer - TcpRxBuffe API need to be
    // used in future!
    ...
    void SetCongestionCtrlAlgo(CongestionCtrl_t ccalgo); // This would be used by attribute system
  ...
  protected: // protected methods
    ...
    void RemoveAddress(vector<MpTcpAddressInfo>& addrs, uint8_t addr_id);
    Ptr<NetDevice> FindOutputNetDevice(
        Ipv4Address); // Find Netdevice object of specific IP address.
  ...
  protected: // protected variables
    ...
    bool is_Checksumming; // according rfc 8684, checksumming must be negotiate during MP_CAPABLE,
