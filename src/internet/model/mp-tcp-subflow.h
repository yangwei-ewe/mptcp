...
namespace ns3 {
    ...
    class MpTcpSubFlow : public Object {
      public:
        ...
        uint32_t maxSeqNb;   // Highest sequence number of a sent byte. Equal to (TxSeqNumber - 1)
      ...
      private:
        ...
        bool m_rttTracking;        // 是否正在追蹤 RTT
        SequenceNumber32 m_rttSeq; // 被追蹤的 seq
        Time m_rttSendTime;        // 該封包的送出時間
    };
